...
namespace GeophysicsNetCDF {
	...
	constexpr const char* DN_POINT = "point";
	constexpr const char* DN_LINE = "line";

	constexpr const char* VN_LI_START = "line_index_start";
	constexpr const char* VN_LI_COUNT = "line_index_count";
	constexpr const char* VN_LINE_INDEX = "line_index";

	constexpr const char* LN_LINE_INDEX = "line_index";
	constexpr const char* LN_LINE_NUMBER = "line_number";
	constexpr const char* LN_SAMPLE_NUMBER = "point_number";
	constexpr const char* LN_FLIGHT_NUMBER = "flight_number";

	constexpr const char* AN_STANDARD_NAME = "standard_name";
	constexpr const char* AN_LONG_NAME = "long_name";
	constexpr const char* AN_UNITS = "units";
	constexpr const char* AN_DESCRIPTION = "description";
	constexpr const char* AN_MISSINGVALUE = "_FillValue";
	constexpr const char* AN_ORIGINAL_DATASET_NAME = "original_dataset_name";
	constexpr const char* AN_ORIGINAL_DATASET_FIELDNAME = "original_dataset_fieldname";
